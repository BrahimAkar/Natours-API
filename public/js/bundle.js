...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYnJhaGltYWthciIsImEiOiJjazkwZWV5MTQwMHJtM2VsZG1mMXFmbjFkIn0.Z9ywdCfnG_M734c9bfdt-Q';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p style=\"background-color:orange;color:white\">Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend map bounds to include current location
